      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
          ...
          <p className="text-white/70 leading-relaxed">
            Trade on sports, crypto, politics, and custom events with real-time odds and transparent
            outcomes.
          </p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
          ...
          <p className="text-white/70 leading-relaxed">
            Built on BlockDAG&apos;s robust infrastructure ensuring security, speed, and full
            transparency for all trades.
          </p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
          ...
          <p className="text-white/70 leading-relaxed">
            Claim your winnings immediately with BlockDAG&apos;s lightning-fast settlement and low
            transaction fees.
          </p>
        </div>
      </div>
