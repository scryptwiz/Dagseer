    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center mb-8">
        ...
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-4xl font-bold text-white">My Positions</h1>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-white/60 text-sm mb-1">Total Winnings</div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-white/60 text-sm mb-1">Unclaimed</div>
      ...
      {/* Tabs */}
      <div className="mb-6">
        <div className="flex space-x-1 p-1 bg-white/5 rounded-xl backdrop-blur-xl border border-white/10 w-fit">
          {[
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-6 text-white/60">
                  ...
                  <div>
                    ...
                    <span className="text-white">{position.marketEndDate}</span>
                  </div>
                </div>
              </div>
